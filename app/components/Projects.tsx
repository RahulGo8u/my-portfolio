    ...
    <section id="projects" className="py-24 bg-[#0d0d14]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {PROJECTS.map((p, i) => (
            <AnimateInView key={p.name} delay={i * 100}>
              <div
                className={`p-6 rounded-xl border card-hover flex flex-col gap-4 h-full ${
                  p.accent
              ...
              >
                ...
                {/* Impact */}
                <div className={`flex gap-2 p-3 rounded-lg ${p.accent ? "bg-indigo-500/10" : "bg-[#16161f]"}`}>
                  ...
                  <div className="flex gap-3 pt-1">
                    {p.github && (
                      <a
                        ...
                        className="flex items-center gap-1.5 text-xs text-[#606078] hover:text-indigo-400 transition-colors"
                      >
                        <Code2 size={13} />
                        View Code
                      </a>
